...
// 1. Define a type (interface) for a Role
interface Role {
  id: number;
  title: string;
  company: string;
...
// 2. Annotate the available roles array with the Role type
const AVAILABLE_ROLES: Role[] = [
  {
    ...
    department: "AI/ML",
    description:
      "Summer internship position focusing on ML models development.",
    requirements: [
...
export default function InterviewPage() {
  ...
  // 3. Use a typed state for selectedRole
  ...
  // 4. Type the conversation callbacks if needed.
  ...
  // 5. Only render the interview view when the interview is started and selectedRole is not null.
  if (isInterviewStarted && selectedRole) {
    return (
  ...
  // 6. Render the list of available roles when the interview is not started.
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto px-6 py-12 pt-20">
        <h1 className="text-4xl font-bold mb-8 text-center text-gray-800">
          Your Interview Matches
        </h1>
