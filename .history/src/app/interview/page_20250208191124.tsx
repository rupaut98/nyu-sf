  ...
  const requestMicrophonePermission = async () => {
    try {
      ...
      const userConsent = window.confirm(
        "This interview requires microphone access to enable voice conversation with the AI interviewer. " +
        "Please allow microphone access when prompted. " +
        "Your audio will only be used for this interview session."
      );
        ...
        <div className="max-w-6xl mx-auto p-8">
          ...
          <div className="grid grid-cols-1 gap-16">
            ...
            <div className="w-full max-w-2xl">
              <elevenlabs-convai agent-id="FvWLLGEEDg1UpAzGmUwk"></elevenlabs-convai>
            </div>
          </div>
        </div>
      </div>
