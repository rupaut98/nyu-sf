        ...
        <div className="flex gap-8">
          <div className="w-1/3">
            <div className="aspect-square rounded-lg overflow-hidden bg-gray-100 shadow-lg">
              <img 
                src="/recruiter-avatar.png" // Add your avatar image
                alt="AI Recruiter"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="mt-4 text-center">
              <h3 className="text-xl font-semibold">AI Recruiter</h3>
              <p className="text-gray-600">Interviewing for {selectedRole.department}</p>
            </div>
          </div>
          <div className="w-2/3">
            <Conversation />
